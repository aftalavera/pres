<?php
//Include Common Files @1-423529D9
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "NacionalSample.php");
...
//Open Method @2-F2CAB099
    function Open()
    {
        ...
        $this->SQL = "EXEC spNacionalParcialSample " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
...
class clsGridGrid4 { //Grid4 class @24-95205137
...
//Class_Initialize Event @24-771DE915
...
} //End Grid4 Class @24-FCB6E20C

class clsGrid4DataSource extends clsDBsql {  //Grid4DataSource Class @24-A2C43A68

//DataSource Variables @24-D5AD4E22
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @24-971E716B
...
//Open Method @24-95511A2B
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["source"] = new clsSQLParameter("urlsource", ccsInteger, "", "", CCGetFromGet("source", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spNacionalProyectadoSample " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
} //End Grid4DataSource Class @24-FCB6E20C

class clsGridGrid5 { //Grid5 class @46-8C3B6076
...
//Class_Initialize Event @46-3A64302E
...
} //End Grid5 Class @46-FCB6E20C

class clsGrid5DataSource extends clsDBsql {  //Grid5DataSource Class @46-CC482129

//DataSource Variables @46-D5AD4E22
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @46-70B216C6
...
//Open Method @46-97F5771C
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["source"] = new clsSQLParameter("urlsource", ccsInteger, "", "", CCGetFromGet("source", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spNacionalParcialPrevioSample " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
} //End Grid5DataSource Class @46-FCB6E20C
...
//Open Method @76-71478121
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["source"] = new clsSQLParameter("urlsource", ccsInteger, "", "", CCGetFromGet("source", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spNacionalTallySample " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Include Page implementation @82-9F39F2CD
include_once(RelativePath . "/HeaderSample.php");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "NacionalSample.html";
$BlockToParse = "main";
...
//Include events file @1-37E87F1B
include_once("./NacionalSample_events.php");
...
$GrafNacionalProy = new clsControl(ccsLabel, "GrafNacionalProy", "GrafNacionalProy", ccsText, "", CCGetRequestParam("GrafNacionalProy", ccsGet, NULL), $MainPage);
$GrafNacionalProy->HTML = true;
$Grid2 = new clsGridGrid2("", $MainPage);
$Header = new clsHeaderSample("", "Header", $MainPage);
$Header->Initialize();
...
$MainPage->GrafNacionalProy = & $GrafNacionalProy;
...
//Go to destination page @1-07A8209D
if($Redirect)
{
