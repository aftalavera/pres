...
// -------------------------
    $GrafNacionalProy->SetValue("<iframe src='./graphs/nacionalproy.php?source=". CCGetFromGet("source", NULL) ."' frameborder='0' width='300' height='250' scrolling='no'></iframe>" );// Write your own code here.
// -------------------------
//End Custom Code
