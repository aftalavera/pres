<?php
//Include Common Files @1-7CA86E08
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Provincia.php");
...
//Show Method @48-82787D74
    function Show()
    {
        ...
        $this->DataSource->Parameters["urlprovincia"] = CCGetFromGet("provincia", NULL);
...
//Open Method @48-1B784EA8
    function Open()
    {
        ...
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spProvincia " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ", "
             . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
...
//Open Method @59-3C8BC45C
    function Open()
    {
        ...
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spProvinciaProyectado " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ", "
             . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
...
//Open Method @71-0140EEBD
    function Open()
    {
        ...
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spProvinciaTally " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ", "
             . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Provincia.html";
$BlockToParse = "main";
...
//Go to destination page @1-1D9819D9
if($Redirect)
{
