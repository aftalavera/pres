...
class clsMenuHeaderSampleMainMenu extends clsMenu { //MainMenu class @1000-2A51662E

//Class_Initialize Event @1000-46941E63
    function clsMenuHeaderSampleMainMenu($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->StaticItems[] = array("item_id" => "MenuItem1", "item_id_parent" => null, "item_caption" => "600", "item_url" => array("Page" => $this->RelativePath . "nacionalsample.php", "Parameters" => array("source" => "1")), "item_target" => "", "item_title" => "");

        $this->DataSource = new clsHeaderSampleMainMenuDataSource($this);
...
//HeaderSampleMainMenuDataSource Class @1000-81C8679A
class clsHeaderSampleMainMenuDataSource extends DB_Adapter {
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    function clsHeaderSampleMainMenuDataSource($parent) {
        $this->Parent = & $parent;
        $this->ErrorBlock = "Menu MainMenu";
...
//End HeaderSampleMainMenuDataSource Class

class clsHeaderSample { //HeaderSample class @1-2FD3B86F
...
//Class_Initialize Event @1-83C21112
    function clsHeaderSample($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "HeaderSample.php";
        $this->Redirect = "";
        $this->TemplateFileName = "HeaderSample.html";
...
//Initialize Method @1-31753FA8
    function Initialize()
    {
        ...
        // Create Components
        $this->MainMenu = new clsMenuHeaderSampleMainMenu($this->RelativePath, $this);
        $this->BindEvents();
...
} //End HeaderSample Class @1-FCB6E20C
