...
// -------------------------
    $MunicipioResult->SetValue("<iframe name='result' src='./municipioprensa.php?source=" . CCGetFromGet("source", NULL) ."&municipio=1' frameborder='0' width='950' height='400' scrolling='no'></iframe>" );// Write your own code here.
// -------------------------
//End Custom Code
