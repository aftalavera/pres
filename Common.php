...
//Connection Settings @0-10138D38
...
//Initialize Common Variables @0-0797817C
...
//sql Connection Class @-DB30F526
class clsDBsql extends DB_Adapter
{
    function clsDBsql()
    {
        $this->Initialize();
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["sql"]);
        parent::Initialize();
