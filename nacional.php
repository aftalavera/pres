<?php
//Include Common Files @1-AE3E7948
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Nacional.php");
...
//Open Method @24-9E445479
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["source"] = new clsSQLParameter("urlsource", ccsInteger, "", "", CCGetFromGet("source", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spNacionalProyectado " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Open Method @46-0F076040
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["source"] = new clsSQLParameter("urlsource", ccsInteger, "", "", CCGetFromGet("source", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spNacionalParcialPrevio " . $this->ToSQL($this->cp["source"]->GetDBValue(), $this->cp["source"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Include Page implementation @82-3DD2EFDC
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Nacional.html";
$BlockToParse = "main";
...
//Include events file @1-E6A11DEC
include_once("./Nacional_events.php");
