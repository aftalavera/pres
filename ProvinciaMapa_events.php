...
// -------------------------
    $ProvinciaResult->SetValue("<iframe name='result' src='./provincia.php?source=" . CCGetFromGet("source", NULL) ."&provincia=1' frameborder='0' width='950' height='400' scrolling='no'></iframe>" );// Write your own code here.
// -------------------------
//End Custom Code
